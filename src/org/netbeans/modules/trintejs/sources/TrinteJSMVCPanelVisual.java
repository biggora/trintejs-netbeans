...
public class TrinteJSMVCPanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private TrinteJSMVCWizardPanel panel;

    public TrinteJSMVCPanelVisual(TrinteJSMVCWizardPanel panel) {
        initComponents();
        this.panel = panel;

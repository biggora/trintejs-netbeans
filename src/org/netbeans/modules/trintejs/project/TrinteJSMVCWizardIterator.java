...
public class TrinteJSMVCWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public TrinteJSMVCWizardIterator() {
    }

    public static TrinteJSMVCWizardIterator createIterator() {
        return new TrinteJSMVCWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
                    new TrinteJSMVCWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
                    NbBundle.getMessage(TrinteJSMVCWizardIterator.class, "LBL_CreateProjectStep")
                };
    }

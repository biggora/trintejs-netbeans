 ...
 * @author Aleks
 */
public class AppFilesNode extends FilterNode {

    @StaticResource
    private static final String IMAGE = "org/netbeans/modules/trintejs/images/box.png";

    public AppFilesNode(Project proj) throws DataObjectNotFoundException {
        super(DataObject.find(proj.getProjectDirectory().
                getFileObject("app")).getNodeDelegate());
    }
